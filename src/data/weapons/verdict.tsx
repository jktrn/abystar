...
const Verdict: Weapon = {
    name: 'Verdict',
    image: 'https://api.ambr.top/assets/UI/UI_EquipIcon_Claymore_GoldenVerdict.png',
    type: 'Claymore',
    rarity: 5,
    description:
