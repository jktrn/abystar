...
const RaidenShogun: Character = {
    name: 'Raiden Shogun',
    icon: 'https://api.ambr.top/assets/UI/UI_AvatarIcon_Shougun.png',
    weapon: 'Polearm',
    vision: 'Electro',
    rarity: 5,
    description:
    ...
    talents: [
        ...
        },
        {
            ...
            image: 'https://api.ambr.top/assets/UI/Skill_S_Shougun_01.png',
            description:
        ...
        },
        {
            ...
            image: 'https://api.ambr.top/assets/UI/UI_Talent_S_Shougun_05.png',
            description:
    ...
    passiveSkills: [
        {
            name: 'All-Preserver',
            image: 'https://api.ambr.top/assets/UI/UI_Talent_S_Shougun_07.png',
            description:
                'Mora expended when ascending Swords and Polearms is decreased by 50%.',
        },
        {
            name: '\u6682\u7f3a',
            image: 'https://api.ambr.top/assets/UI/UI_Talent_S_Shougun_06.png',
            description: '\u65e0\u6cd5\u53c2\u4e0e\u6599\u7406',
        },
        {
            name: 'Wishes Unnumbered',
            image: 'https://api.ambr.top/assets/UI/.png',
            description:
    ...
    constellations: [
        {
            ...
            image: 'https://api.ambr.top/assets/UI/UI_Talent_S_Shougun_01.png',
            description:
        ...
        {
            name: 'Steelbreaker',
            image: 'https://api.ambr.top/assets/UI/UI_Talent_S_Shougun_03.png',
            description:
        ...
        },
        {
            ...
            image: 'https://api.ambr.top/assets/UI/UI_Talent_U_Shougun_02.png',
            description:
        ...
        },
        {
            ...
            image: 'https://api.ambr.top/assets/UI/UI_Talent_S_Shougun_02.png',
            description:
        ...
        },
        {
            ...
            image: 'https://api.ambr.top/assets/UI/UI_Talent_U_Shougun_01.png',
            description:
        ...
        {
            name: 'Wishbearer',
            image: 'https://api.ambr.top/assets/UI/UI_Talent_S_Shougun_04.png',
            description:
