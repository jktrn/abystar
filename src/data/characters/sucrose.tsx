...
const Sucrose: Character = {
    name: 'Sucrose',
    icon: '/images/characters/UI_AvatarIcon_Sucrose.png',
    weapon: 'Catalyst',
    vision: 'Anemo',
    rarity: 4,
    description:
    ...
    talents: [
        ...
        },
        {
            ...
            image: '/images/characters/Skill_S_Sucrose_01.png',
            description:
        ...
        },
        {
            ...
            image: '/images/characters/Skill_E_Sucrose_01.png',
            description:
    ...
    passiveSkills: [
        {
            ...
            image: '/images/characters/UI_Talent_Combine_Material.png',
            description:
        ...
        },
        {
            ...
            image: '/images/characters/UI_Talent_S_Sucrose_05.png',
            description:
        ...
        },
        {
            ...
            image: '/images/characters/UI_Talent_S_Sucrose_06.png',
            description:
    ...
    constellations: [
        {
            ...
            image: '/images/characters/UI_Talent_S_Sucrose_01.png',
            description:
        ...
        },
        {
            ...
            image: '/images/characters/UI_Talent_S_Sucrose_02.png',
            description:
                'The duration of\nForbidden Creation - Isomer 75 / Type II\nis increased by 2s.',
            level: 2,
        },
        {
            ...
            image: '/images/characters/UI_Talent_U_Sucrose_01.png',
            description:
        ...
        {
            name: 'Alchemania',
            image: '/images/characters/UI_Talent_S_Sucrose_03.png',
            description:
        ...
        },
        {
            ...
            image: '/images/characters/UI_Talent_U_Sucrose_02.png',
            description:
                'Increases the Level of\nForbidden Creation - Isomer 75 / Type II\nby 3.\nMaximum upgrade level is 15.',
            level: 5,
        },
        {
            ...
            image: '/images/characters/UI_Talent_S_Sucrose_04.png',
            description:
