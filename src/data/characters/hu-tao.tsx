    ...
    },
    {
        ...
        effect: (attributes, initialAttributes) => {
            ...
            const newAttributes = {
                ...
                'Electro RES': initialAttributes['Electro RES'] + 2,
                'Hydro RES': initialAttributes['Hydro RES'] + 2,
                'Geo RES': initialAttributes['Geo RES'] + 2,
                'Anemo RES': initialAttributes['Anemo RES'] + 2,
                'Dendro RES': initialAttributes['Dendro RES'] + 2,
