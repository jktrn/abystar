...
const characterBonuses: Bonus[] = [
    {
        ...
        icon: '/images/characters/UI_Talent_S_Yelan_05.png',
    ...
    },
    {
        ...
        icon: '/images/characters/UI_Talent_S_Yelan_06.png',
        effect: (attributes, talentLevels, currentStacks) => {
            if (!currentStacks) return { attributes }
...
const constellationBonuses: Bonus[] = [
    {
        ...
        icon: '/images/characters/UI_Talent_S_Yelan_01.png',
        effect: (attributes) => {
            // * Unimplementable
            return { attributes }
        },
    ...
    },
    {
        ...
        icon: '/images/characters/UI_Talent_S_Yelan_02.png',
        effect: (attributes) => {
    ...
    },
    {
        ...
        icon: '/images/characters/UI_Talent_U_Yelan_01.png',
    ...
    },
    {
        ...
        icon: '/images/characters/UI_Talent_S_Yelan_03.png',
        effect: (attributes, talentLevels, currentStacks) => {
            if (!currentStacks) return { attributes }
    ...
    },
    {
        ...
        icon: '/images/characters/UI_Talent_U_Yelan_02.png',
        effect: (attributes, talentLevels) => {
            if (!talentLevels) return { attributes }
    ...
    },
    {
        ...
        icon: '/images/characters/UI_Talent_S_Yelan_04.png',
        effect: (attributes) => {
            // * Already handled in talentScalings
            return { attributes }
        },
...
const Yelan: Character = {
    name: 'Yelan',
    icon: '/images/characters/UI_AvatarIcon_Yelan.png',
    weapon: 'Bow',
    vision: 'Hydro',
    rarity: 5,
    description:
    ...
    talents: [
        ...
        },
        {
            ...
            image: '/images/characters/Skill_S_Yelan_01.png',
            description:
        ...
        },
        {
            ...
            image: '/images/characters/Skill_E_Yelan_01.png',
            description:
    ...
    passiveSkills: [
        ...
        {
            name: 'Turn Control',
            image: '/images/characters/UI_Talent_S_Yelan_05.png',
            description:
                "When the party has 1/2/3/4 Elemental Types, Yelan's Max HP is increased by 6%/12%/18%/30%.",
        },
        {
            name: 'Adapt With Ease',
            image: '/images/characters/UI_Talent_S_Yelan_06.png',
            description:
    ...
    constellations: [
        {
            name: 'Enter the Plotters',
            image: '/images/characters/UI_Talent_S_Yelan_01.png',
            description: 'Lingering Lifeline\ngains 1 additional charge.',
            level: 1,
        },
        {
            name: 'Taking All Comers',
            image: '/images/characters/UI_Talent_S_Yelan_02.png',
            description:
        ...
        {
            name: "Beware the Trickster's Dice",
            image: '/images/characters/UI_Talent_U_Yelan_01.png',
            description:
                'Increases the Level of\nDepth-Clarion Dice\nby 3.\nMaximum upgrade level is 15.',
            level: 3,
        },
        {
            name: 'Bait-and-Switch',
            image: '/images/characters/UI_Talent_S_Yelan_03.png',
            description:
        ...
        {
            name: "Dealer's Sleight",
            image: '/images/characters/UI_Talent_U_Yelan_02.png',
            description:
                'Increases the Level of\nLingering Lifeline\nby 3.\nMaximum upgrade level is 15.',
            level: 5,
        },
        {
            name: 'Winner Takes All',
            image: '/images/characters/UI_Talent_S_Yelan_04.png',
            description:
