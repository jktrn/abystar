...
const characterBonuses: Bonus[] = [
    {
        ...
        icon: '/images/characters/UI_Talent_S_Keqing_05.png',
        effect: (attributes) => {
            // * Unnecessary
            return { attributes }
        },
    ...
    },
    {
        ...
        icon: '/images/characters/UI_Talent_S_Keqing_06.png',
        effect: (attributes) => {
            const newAttributes = {
                ...attributes,
...
const constellationBonuses: Bonus[] = [
    {
        ...
        icon: '/images/characters/UI_Talent_S_Keqing_01.png',
        effect: (attributes) => {
            // * Unnecessary
            return { attributes }
        },
    ...
    },
    {
        ...
        icon: '/images/characters/UI_Talent_S_Keqing_02.png',
        effect: (attributes) => {
    ...
    },
    {
        ...
        icon: '/images/characters/UI_Talent_U_Keqing_01.png',
    ...
    },
    {
        ...
        icon: '/images/characters/UI_Talent_S_Keqing_03.png',
        effect: (attributes) => {
            const newAttributes = {
                ...attributes,
    ...
    },
    {
        ...
        icon: '/images/characters/UI_Talent_U_Keqing_02.png',
        effect: (attributes, talentLevels) => {
            if (!talentLevels) return { attributes }
    ...
    },
    {
        ...
        icon: '/images/characters/UI_Talent_S_Keqing_04.png',
...
const Keqing: Character = {
    name: 'Keqing',
    icon: '/images/characters/UI_AvatarIcon_Keqing.png',
    weapon: 'Sword',
    vision: 'Electro',
    rarity: 5,
    description:
    ...
    talents: [
        ...
        },
        {
            ...
            image: '/images/characters/Skill_S_Keqing_01.png',
            description:
        ...
        {
            name: 'Starward Sword',
            image: '/images/characters/Skill_E_Keqing_01.png',
            description:
    ...
    passiveSkills: [
        ...
        {
            name: 'Thundering Penance',
            image: '/images/characters/UI_Talent_S_Keqing_05.png',
            description:
                "After recasting\nStellar Restoration\nwhile a Lightning Stiletto is present, Keqing's weapon gains an\nElectro Infusion\nfor 5s.",
        },
        {
            name: 'Aristocratic Dignity',
            image: '/images/characters/UI_Talent_S_Keqing_06.png',
            description:
    ...
    constellations: [
        {
            name: 'Thundering Might',
            image: '/images/characters/UI_Talent_S_Keqing_01.png',
            description:
        ...
        {
            name: 'Keen Extraction',
            image: '/images/characters/UI_Talent_S_Keqing_02.png',
            description:
        ...
        {
            name: 'Foreseen Reformation',
            image: '/images/characters/UI_Talent_U_Keqing_01.png',
            description:
                'Increases the Level of\nStarward Sword\nby 3.\nMaximum upgrade level is 15.',
            level: 3,
        },
        {
            name: 'Attunement',
            image: '/images/characters/UI_Talent_S_Keqing_03.png',
            description:
        ...
        {
            name: 'Beckoning Stars',
            image: '/images/characters/UI_Talent_U_Keqing_02.png',
            description:
                'Increases the Level of\nStellar Restoration\nby 3.\nMaximum upgrade level is 15.',
            level: 5,
        },
        {
            name: 'Tenacious Star',
            image: '/images/characters/UI_Talent_S_Keqing_04.png',
            description:
